...
public class KafkaBookProducerKey {
    ...
    private static final Logger logger = LoggerFactory.getLogger(KafkaBookProducerKey.class);
    ...
    public static void main(String[] args) {
        ...
        try (Producer<String, String> producer = new KafkaProducer<>(props)) {
            ...
            for (int i = 1; i < 11; i++) {
                ...
                if (i % 2 == 1) {
                    value = String.format("%d - Apache Kafka is a distributed streaming platform - key=" + oddKey, i);
                    producer.send(new ProducerRecord<>(topic, oddKey, value));
                } else {
                    value = String.format("%d - Apache Kafka is a distributed streaming platform - key=" + evenKey, i);
                    producer.send(new ProducerRecord<>(topic, evenKey, value));
                }
